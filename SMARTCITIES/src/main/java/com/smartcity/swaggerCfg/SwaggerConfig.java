/*
 * package com.smartcity.swaggerCfg;
 * 
 * 
 ...
 * .title("CVRINDIA API") .description("CVRINDIA API's") .version("1.0.0")
 * .termsOfServiceUrl("http://cvrindia.com") .license("CVRINDIA License")
 * .licenseUrl("http://cvrindia.com") .build(); }
 * 
 * }
 */