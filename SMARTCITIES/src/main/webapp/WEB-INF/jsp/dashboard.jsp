  ...
  <div class="app-header">
    <div class="app-header-left">
      ...
      <div class="search-wrapper">
        <input class="search-input" type="text" placeholder="Search" name="keyword" value=${keyword}>
              <button type="submit">
              </button>
     </form>   
    ...
    <div class="app-header-right">
      ...
      <form action="/addPost" >
      <button class="add-btn" title="Add New Post">
      ...
      <div class="card__overlay">
        <div class="card__header">
          ...
          <div class="card__header-text">
            <h3 class="card__title">${detail.name}</h3>            
            <span class="card__status">${detail.city_name}</span>
          </div>
        </div>
        <form action="/bookcab">
        <input class="card__description" type="submit" value="book cab"   >
        </form>
      </div>
    </a>      
  </li> 
